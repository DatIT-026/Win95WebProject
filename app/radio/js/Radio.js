class Radio {
	...
	constructor(){
      ...
      {name: 'Feliz Navidad', slug: 'FN', src: '././radio-file/Feliz_Navidad.mp3'},
	  ...
	  {name: 'We Wish You a Merry Christmas 1', slug: 'WWYaMC', src: '././radio-file/we.wish.you.1.mp3'},
	  {name: 'We Wish You a Merry Christmas 2', slug: 'WWYaMC', src: '././radio-file/we.wish.you.2.mp3'},
	  {name: 'We Wish You a Merry Christmas 3', slug: 'WWYaMC', src: '././radio-file/we.wish.you.3.mp3'},
	  {name: 'We Wish You a Merry Christmas 4', slug: 'WWYaMC', src: '././radio-file/we.wish.you.4.mp3'},
